...
$0 
	...
	look for the IDs in your input fastq file, outputing
...
print STDERR "Number of Targeted IDs to Extract: $num_ids\n";
...
print STDERR "$num_found of $num_ids records found.\n";
print STDERR "$rec_idx records processed.\n";

if($num_found != $num_ids){
	print STDERR "WARNING: NOT ALL RECORDS REQUESTED FOUND!\n";
}
