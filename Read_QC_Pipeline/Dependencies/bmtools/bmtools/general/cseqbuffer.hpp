...
public:
#ifndef STANDALONE
    typedef objects::CSeqVector TSeqVector;
#else
    ...
    CSeqBuffer( const TSeqVector& vect, CSeqCoding::ECoding );
...
inline CSeqBuffer::CSeqBuffer( const TSeqVector& vect, CSeqCoding::ECoding tgtCoding )
