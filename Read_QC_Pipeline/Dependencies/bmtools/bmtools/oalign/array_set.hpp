...
////////////////////////////////////////////////////////////////////////
// $Id: array_set.hpp 382804 2012-12-10 02:38:55Z rotmistr $
////////////////////////////////////////////////////////////////////////

BEGIN_NCBI_SCOPE

template<typename T, typename Cmp = less<T>, int kCapacityIncrement = 10000 >
class array_set
{
public:
    ...
    bool operator != ( const array_set& other ) const { return !operator == ( other ); }
    bool operator == ( const array_set& other ) const {
        if( &other == this ) return true;
        if( size() != other.size() ) return false;
        for( const_iterator a = begin(), b = other.begin(); a != end(); ++a, ++b ) 
            if( *a != *b ) return false;
        return true;
    }
